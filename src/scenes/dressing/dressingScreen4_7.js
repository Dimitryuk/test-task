...
export default class DressingScreen4_7 extends Phaser.Scene {
  constructor() {
    super("dressingScreen4_7");
  }
  ...
  preload() {
    ...
    this.load.image(
      "girl_shorts_brown_handbag_glasses",
      "assets/girl_shorts_brown_handbag_glasses.webp"
    );
  ...
  create() {
    ...
    this.girl = this.add
      .image(300, 500, "girl_shorts_brown_handbag_glasses")
      .setScale(1.1);

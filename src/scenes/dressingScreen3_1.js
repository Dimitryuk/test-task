...
export default class DressingScreen3_1 extends Phaser.Scene {
  constructor() {
    super("dressingScreen3_1");
  }
  ...
  preload() {
    ...
    this.load.image(
      "girl_pink_dress_blue_handbag",
      "assets/girl_pink_dress_blue_handbag.webp"
    );
  ...
  create() {
    ...
    this.girl = this.add
      .image(300, 500, "girl_pink_dress_blue_handbag")
      .setScale(1.1);
    ...
    this.rectangle.on("pointerdown", () => {
      this.scene.start("dressingScreen4_1");
    });

    this.rectangle1.setInteractive();
    this.rectangle1.on("pointerdown", () => {
      this.scene.start("dressingScreen4_2");
    });
  }
  update() {}
}

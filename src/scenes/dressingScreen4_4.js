...
export default class DressingScreen4_4 extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image(
      "girl_pink_dress_brown_handbag_choker",
      "assets/girl_pink_dress_brown_handbag_choker.webp"
    );
  ...
  create() {
    ...
    this.girl = this.add
      .image(300, 500, "girl_pink_dress_brown_handbag_choker")
      .setScale(1.1);

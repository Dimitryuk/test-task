...
export default class DressingScreen3_4 extends Phaser.Scene {
  constructor() {
    super("dressingScreen3_4");
  }

  preload() {
    this.load.image("room", "assets/room.webp");
    this.load.image(
      "girl_shorts_brown_handbag",
      "assets/girl_shorts_brown_handbag.webp"
    );
    ...
    this.load.image("neckchain", "assets/neckchain.webp");
  ...
  create() {
    ...
    this.girl = this.add
      .image(300, 500, "girl_shorts_brown_handbag")
      .setScale(1.1);
    ...
    this.choker = this.add.image(450, 700, "neckchain");
    ...
    this.rectangle.on("pointerdown", () => {
      this.scene.start("dressingScreen4_7");
    });

    this.rectangle1.setInteractive();
    this.rectangle1.on("pointerdown", () => {
      this.scene.start("dressingScreen4_8");
    });
  }
  update() {}
}

...
export default class DressingScreen3_3 extends Phaser.Scene {
  constructor() {
    super("dressingScreen3_3");
  }
  ...
  preload() {
    ...
    this.load.image(
      "girl_shorts_blue_handbag",
      "assets/girl_shorts_blue_handbag.webp"
    );
  ...
  create() {
    ...
    this.girl = this.add
      .image(300, 500, "girl_shorts_blue_handbag")
      .setScale(1.1);
    ...
    this.rectangle.on("pointerdown", () => {
      this.scene.start("dressingScreen4_5");
    });

    this.rectangle1.setInteractive();
    this.rectangle1.on("pointerdown", () => {
      this.scene.start("dressingScreen4_6");
    });
  }
  update() {}
}
